<%@page import="com.qxy.exception.PasswordNotCorrectException"%>
<%@page import="com.qxy.exception.UserNotFoundException"%>
<%@page import="com.qxy.entity.*"%>
<%@ page language="java" import="java.util.*,com.qxy.manager.*" pageEncoding="UTF-8"%>
...
<%
	...
	if(action !=null && action.equals("login")){
		...
		try{
			...
			u = UserManager.getInstance().validate(username, password);
	...
	//out.println("恭喜您登陆成功"+u.getUsername());
