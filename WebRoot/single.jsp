...
<%
	...
	if(action !=null && action.trim().equals("buy")){
		...
		item.setCount(count);
		//item.setPrice(price);
		item.setNormalprice(p.getNormalPrice());
		item.setMemberprice(p.getMemberPrice());
		item.setPrice(p.getNormalPrice());
		item.setProductid(id);
		item.setName(name);
		cart.add(item);
		//System.out.println(item.getCount()+","+item.getPrice());
	...
	String normalprice = bd.toString();
...
<script type="text/javascript" src="script/hover_pack.js"></script>
<link rel="stylesheet" href="css/etalage.css">
<script src="script/jquery.etalage.min.js"></script>
<script>
	...
	<div class="header_top">
		<div class="container">
			...
			<ul class="shopping_grid">
			      <a href="rejister.jsp"><li>Join</li></a>
	   ...
	   <div class="col-md-9 single_right">
	       ...
	       <div class="single_grid">
						...
						<ul id="etalage">
							<li>
								<a href="optionallink.html">
									<img class="etalage_thumb_image" src="images/product/<%=id%>.jpg" class="img-responsive" />
									<img class="etalage_source_image" src="images/product/<%=id%>.jpg" class="img-responsive" title="" />
								</a>
							</li>
							 <li>
			    ...
			    <div class="price_single">
				  <span class="reducedfrom">$<%=normalprice%></span>
				  <span class="actual">$<%=memberprice%></span><a href="#">click for offer</a>
				</div>
				<h2 class="quick">Descrption:</h2>
				<p class="quick_desc"><%=p.getDescr() %></p>
			    <div class="wish-list">
				 	<ul>
				...
				<form action="single.jsp" method="post">
					...
					<input type="hidden" name="price" value="<%=memberprice%>">
				    ...
				    <ul class="single_social">
		   		    ...
		   		    <div class="clearfix"></div>
		   		    <!--  <a href="" title="Online Reservation" class="btn bt1 btn-primary btn-normal btn-inline " target="_self"></a>-->
		   		     <input style="width:60px;height:40px;" class = " bt1  btn-primary  btn-normal  btn-inline" type="submit" value="BUY">
		   		    </form>
	   		    </div>
	    ...
	    <div class="related_products">
	     	...
	     	<%
	     		for(int i=0;i<prodcuts.size();i++){
	    			...
	    			Integer intvalue = new Double(price).intValue();
