...
<%
	...
	if(action !=null && action.trim().equals("modify"))
	{
		...
		if(opassword.equals(u.getPassword())){
...
<body>
		...
		<div class="h_menu4">
			...
			<div class="container">
				...
				<ul class="nav">
					...
					<li class="active"><a href="register.jsp"
	...
	<div class="about">
		<div class="container">
			<div class="register">
				<form name="form" id="from" action="userModifyPassWd.jsp" method="post"
					...
					<div class="register-top-grid">
						...
						<div>
							...
							</span> <input type="text" name="username" disabled="disabled"
										value="<%=u.getUsername() %>">
						</div>
						<div class="clearfix"></div>
						<a class="news-letter" href="#"> <label class="checkbox"></label> </a>
						<div>
							<span>Your Old Password<label>*</label>
							</span> <input type="password" name="opassword" >
						</div>
						<div>
							<span>New Password<label>*</label>
							</span> <input type="password" name="password" >
						</div>
						<div>
							<span>Confirm New Password<label>*</label>
