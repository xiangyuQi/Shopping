...
<body>
	...
	<div class="about">
		<div class="container">
			<div class="register">
				<form name="form" id="from" action="userModify.jsp" method="post"
					...
					<div class="register-top-grid">
						...
						<div>
							...
							</span> <input type="text" name="phone" value="<%=u.getPhone() %>">
						</div>
						<div>
							<span>Your Address<label>*</label>
							</span> <input type="text" name="addr" value="<%=u.getAddr() %>">
						</div>
